    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0" style="">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <a href="{{ route('store') }}" >
                        <span class="menu-link">
                            <span class="menu-icon">
                                ...
                                <span class="menu-title">Stores Home</span>
                        </span>
                    </a>
                </div>
                ...
                <div class="menu-item menu-accordion">
                    <a href="{{ route('dashbord') }}" >
                        <span class="menu-link {{ request()->is('dashbord') ? 'active' : '' }}" >
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div  class="menu-item menu-accordion">
                    <a href="{{ route('category') }}">
                        <span class="menu-link {{ request()->is('category') ? 'active' : '' }}">
                            <span class="menu-icon">
                ...
                <div  class="menu-item menu-accordion">
                    <a href="{{ route('order') }}">
                        <span class="menu-link {{ request()->is('order') ? 'active' : '' }}">
                            <span class="menu-icon">
                ...
                <div class="menu-item menu-accordion">
                    <a href="{{ route('customer') }}">
                        <span class="menu-link {{ request()->is('customer') ? 'active' : '' }}">
                            <span class="menu-icon">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link {{ (Request::is('product/*') ||Request::is('product') )?" active":"" }}">
                        <span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('product.add.view') }}">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                    <span class="menu-link {{ (Request::is('setting/*') ||Request::is('setting') )?" active":"" }}">
                        <span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link"  href="{{ route('settings.index') }}">
                                ...
                                <span class="menu-title">Smart Form</span>
                            </a>
                        </div>
                    </div>
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link"  href="{{ route('settings.script') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">My script</span>
                            </a>
                        </div>
                    </div>
                </div>
