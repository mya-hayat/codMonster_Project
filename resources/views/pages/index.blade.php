        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="row gy-5 g-xl-8">
                ...
                <div class="col-xl-12">
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card card-xxl-stretch mb-5 mb-xl-10" style="background-color: #efd5ed">
                                ...
                                <div class="d-flex align-items-sm-center mb-7">
                                    <div class="symbol symbol-50px me-5">
                                        <span class="symbol-label">
                                            <img src="/images/order.png" class="h-50 align-self-center" alt="">
                                        </span>
                                    </div>
                ...
                <div class="col-xxl-6">
                    <div class="card card-xl-stretch mb-5 mb-xl-10">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-dark">Last Customers</span>
                                <span class="text-muted mt-1 fw-bold fs-7">5 Latest Customers</span>
                            </h3>
                        </div>
                        <div class="card-body pt-5">
                            @foreach (@$customer_last as $item)
                                <div class="d-flex align-items-sm-center mb-7">
                                    <div class="symbol symbol-50px me-5">
                                        <span class="symbol-label">
                                            {{--  image  --}}
                                            <img src="/images/homme.png" class="h-50 align-self-center" alt="">
                                        </span>
                                    </div>
                                    <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                        <div class="flex-grow-1 me-2">
