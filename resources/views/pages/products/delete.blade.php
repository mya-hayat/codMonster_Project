...
<div class="modal fade delete" id="modalDeleteProduct" tabindex="-1" style="display: none;" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-400px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <div id="modalDeleteProduct" aria-labelledby="swal2-title" aria-describedby="swal2-html-container" class="swal2-popup swal2-modal swal2-icon-warning swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: grid;">
                <a class="swal2-close close-deleteProduct">&times;</a>
                ...
                <div class="swal2-html-container" id="swal2-html-container" style="display: block;">
                    <div class="modal-body">
                        <p id="title_confirm">Are you sure you want to delete ...?</p>
                    </div>
                </div>
