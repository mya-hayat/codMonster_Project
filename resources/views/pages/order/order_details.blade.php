            ...
            <div class="d-flex flex-column gap-7 gap-lg-10">
                ...
                <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                                ...
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">COD
                                        </tr>
                                        <!--end::Payment method-->
                                        <!--begin::Date-->
                                        <tr>
                                            <td class="text-muted">
                                                ...
                                                <!--end::Svg Icon-->Total Price</div>
                                            </td>
                                            <td class="fw-bolder text-end">{{ $order->total_price }} {{ $store->currency }}</td>
                                        </tr>
                                        <!--end::Date-->
                                    </tbody>
                                    <!--end::Table body-->
                    ...
                    <div class="card card-flush py-4 flex-row-fluid">
                        ...
                        <div class="card-header">
                            <div class="card-title">
                               <a class="text-gray-600 text-hover-primary" data-customer="{{ $customer->id }}" href="{{ route('customer.infos',['id'=>$customer->id]) }}"> <h2>Customer Details</h2></a>
                            </div>
                        </div>
                        <!--end::Card header-->
                        <!--begin::Card body-->
                                ...
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">
                                                <div class="d-flex align-items-center justify-content-end">
                                                    <!--begin::Name-->
                                                    <a  class="text-gray-600 text-hover-primary">{{ $customer->first_name }} {{ $customer->last_name }}</a>
                                                    <!--end::Name-->
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">
                                                <a href="/metronic8/demo1/../demo1/apps/user-management/users/view.html" class="text-gray-600 text-hover-primary">{{ $customer->email }}</a>
                                            </td>
                                        </tr>
                                        <!--end::Payment method-->
                                        <!--begin::Date-->
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">{{ $customer->phone }}</td>
                                        </tr>
                                        <!--end::Date-->
                                    </tbody>
                                    <!--end::Table body-->
                            ...
                            <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                                ...
                                <div class="card card-flush py-4 flex-row-fluid overflow-hidden">
                                    ...
                                    <div class="position-absolute top-0 end-0 opacity-10 pe-none text-end">
                                        <img src="/metronic8/demo1/assets/media/icons/duotune/ecommerce/ecm001.svg" class="w-175px">
                                    </div>
                                    <!--end::Background-->
                                    <!--begin::Card header-->
                                    <div class="card-header">
                                    ...
                                    <!--end::Card header-->
                                    <!--begin::Card body-->
                                    <div class="card-body pt-0">{{ $address->city }}/{{ $address->country }},
                                    <br>{{ $address->country }},
                                    <br>{{ $address->zip_code}}.</div>
                                    <!--end::Card body-->
                                </div>
                                <!--end::Payment address-->
                                ...
                                <div class="card card-flush py-4 flex-row-fluid overflow-hidden">
                                    <!--begin::Background-->
                                    <div class="position-absolute top-0 end-0 opacity-10 pe-none text-end">
                                        <img src="/metronic8/demo1/assets/media/icons/duotune/ecommerce/ecm006.svg" class="w-175px">
                                    </div>
                                    <!--end::Background-->
                                    <!--begin::Card header-->
                                    <div class="card-header">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <!--begin::Title-->
                                                                    <div class="ms-5">
                                                                        <a href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/edit-product.html" class="fw-bolder text-gray-600 text-hover-primary">{{ $product->title }}</a>
                                                                        @if( $order->status == 'Shipping')
                                                                            <div class="fs-7 text-muted">Delivery Date: {{ $order->updated_at }}</div>
                                                                        @endif
                                                                    </div>
                                                                    <!--end::Title-->
                                                                </div>
                                                            ...
                                                            <!--begin::SKU-->
                                                                ...
                                                                <!--end::SKU-->
                                                                <!--begin::Quantity-->
                                                                <td class="text-end">{{ $item->qty_com }}</td>
                                                                <!--end::Quantity-->
                                                                <!--begin::Price-->
                                                                <td class="text-end">{{ $item->price }}</td>
                                                                <!--end::Price-->
                                                                <!--begin::Total-->
                                                                <td class="text-end">${{ $item->price*$item->qty_com }}</td>
                                                                <!--end::Total-->
                                                        </tr>
                                                    @endforeach
                                                @endforeach
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">{{ $order->sub_total }} {{ $store->currency }}</td>
                                                </tr>
                                                <!--end::Subtotal-->
                                                <!--begin::VAT-->
                                                <tr>
                                                    <td colspan="4" class="text-end">Total Discount</td>
                                                    <td class="text-end">{{ $order->total_discount }} {{ $store->currency }}</td>
                                                </tr>
                                                <!--end::VAT-->
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-dark fs-3 fw-boldest text-end">{{ $order->total_price }} {{ $store->currency }}</td>
                                                </tr>
                                                <!--end::Grand total-->
                                            </tbody>
                                            <!--end::Table head-->
