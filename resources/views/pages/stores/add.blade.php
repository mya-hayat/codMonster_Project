...
<div class="modal fade" id="modalAddStore" tabindex="-1" style="display: none;" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-600px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body py-lg-10 px-lg-10">
                <form  action="{{ route('store.add') }}" method="POST" class="form"  >
                    @csrf
                    <!--begin::Add store-->
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                ...
                                <!--end::Label name-->
                                <!--begin::Input name-->
                                <input type="text" name="name" class="form-control mb-2" placeholder="Store name" value=""  required>
                                <!--end::Input name-->
                            ...
                            <!--end::Input group-->
                             ...
                             <div class="mb-10 fv-row fv-plugins-icon-container">
                                ...
                                <!--end::Label domain-->
                                <!--begin::Input domain-->
                                <input type="text" name="domain" class="form-control mb-2" placeholder="Domain" value=""  required>
                                <!--end::Input domain-->
                            <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                ...
                                <!--begin::input country_name-->
                                    ...
                                    <select name="country_name" id="country_name" data-hide-search="false" class="form-select form-select-solid select2-hidden-accessible"  data-control="select2" data-placeholder="Status" data-kt-ecommerce-store-filter="status" data-select2-id="select2-data-10-wl54" tabindex="-1" aria-hidden="true">
                                            ...
                                            <option data-code="MA" data-id="MAD" value="Morocco" selected>Morocco</option>
                            ...
                            <!--end::Input group-->
                             ...
                             <div class="mb-10 fv-row fv-plugins-icon-container">
                                ...
                                <input type="text" name="country_code" id="country_code" class="form-control mb-2" placeholder="Country code" value=""  required>
                            ...
                            <!--end::Input group-->
                             ...
                             <div class="mb-10 fv-row fv-plugins-icon-container">
                                ...
                                <input type="text" name="currency" id="currency" class="form-control mb-2" placeholder="Currency" value="" required>
                                <!--end::Input currency-->
                            <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            <!--end::Input group-->
                    ...
                    <div class="d-flex justify-content-end">
                       <!--begin::Button-->
                       <a href="{{ Route('store') }}" class="btn btn-light me-5">Cancel</a>
                       <!--end::Button-->
                       <!--begin::Button-->
