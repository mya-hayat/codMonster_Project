...
<div class="modal fade delete" id="modalDeleteStore" tabindex="-1" style="display: none;" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-400px">
        ...
        <div class="modal-content">
            <div id="modalDeleteStore" aria-labelledby="swal2-title" aria-describedby="swal2-html-container" class="swal2-popup swal2-modal swal2-icon-warning swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: grid;">
                ...
                <div class="swal2-actions" style="display: flex;">
                    ...
                    <form action="{{ route('store.remove') }}"  method="POST">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="id" value="" id="id_store">
